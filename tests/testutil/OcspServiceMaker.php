...
class OcspServiceMaker
{
    ...
    private static function getAiaOcspServiceConfiguration(): AiaOcspServiceConfiguration
    {
        return new AiaOcspServiceConfiguration(
            ...
            CertificateValidator::buildTrustAnchorsFromCertificates(array(Certificates::getTestEsteid2018CA(),Certificates::getTestEsteid2018CAGov(), Certificates::getTestEsteid2015CA()))
        ); // ,
