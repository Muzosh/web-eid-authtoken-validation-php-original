...
class Certificates
{
    ...
    private static X509 $testEsteid2018CA;
    private static X509 $testEsteid2015CA;

    private static X509 $jaakKristjanEsteid2018Cert;
    private static X509 $mariliisEsteid2015Cert;
    private static X509 $testSkOcspResponder2020;

    public static function loadCertificates(): void
    {
        $certificates = CertificateLoader::loadCertificatesFromPath('../_resources', 'TEST_of_ESTEID-SK_2015.cer', 'TEST_of_ESTEID2018.cer', 'TEST_of_SK_OCSP_RESPONDER_2020.cer');
